package com.dar3.game.service.impl;
...
import com.dar3.game.exceptions.BadRequestException;
import com.dar3.game.exceptions.NotFoundException;
import com.dar3.game.repository.PlayerRepository;
import com.dar3.game.service.PlayerService;
...
//was added recommended cast to long
    ...
    public Player editPlayer(Player newCharacteristics, Long id) {
        ...
        if (newCharacteristics.getBirthday() != null) {
            ...
            if (birthday.isEmpty() || !isBirthdayCorrect(newCharacteristics)) {
                throw new BadRequestException();
            }
        ...
        if (newCharacteristics.isBanned() != null) {
            ...
            if (banned.isEmpty()) {
                newCharacteristics.setBanned(false);
            }
        ...
        if (newCharacteristics.getExperience() != null) {
            ...
            Integer tempExperience = newCharacteristics.getExperience();
            if (tempExperience < 0 || tempExperience > 10000000) {
                throw new BadRequestException();
            }
            editablePlayer.setExperience(tempExperience);
        }
    ...
    // 4. Is ID correct? (not null, >0, no fraction numbers)
